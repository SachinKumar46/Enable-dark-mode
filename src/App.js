...
function App() {
  const [colorChange, setColorcolorChange] = useState({
    color:"black",
  ...
  return (
    <>
      ...
      <div className="container  py-3 my-5" style={colorChange}>
        <div className="accordion my-3" id="accordionExample" style={colorChange}>
      ...
      <button type='button' classNameName='btn btn-primary btn-sm' onClick={enableDarkModeOnclick}>{btnText}</button>
      </div>
    </>
  );
}
